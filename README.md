...
Validated against independent train/test cohorts: the r² inferred from the
training summary statistics alone tracks the PRS's actual R² in the held-out
cohort (e.g. inferred 0.485 vs held-out 0.495 at N=8000), and falls toward 0
